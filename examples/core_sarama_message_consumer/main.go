...
import (
	...
	"github.com/aykanferhat/go-kafka-partition-scaler/examples/core_sarama_message_consumer/consumers"
	"github.com/aykanferhat/go-kafka-partition-scaler/examples/core_sarama_message_consumer/consumers/interceptors"
	"github.com/aykanferhat/go-kafka-partition-scaler/examples/core_sarama_message_consumer/log"
)
